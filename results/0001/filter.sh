...
VDRIVE='virtual_agents/mct_driver_simulation.log*'

INSTANCE_PATTERN="INTANCES"

BASEINSTOTAL="formated_results/total_inst_running"
BASEINSTANCE="formated_results/instance_in_player"
BASEFAIRNESS="formated_results/fairness_by_player"
BASEREQUESTS="formated_results/requests_by_player"
BASEACCEPTED="formated_results/accepted_by_player"
