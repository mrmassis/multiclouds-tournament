...
## DEFINITIONS                                                               ##
###############################################################################
VAGENT_CONFIG_FILE   = 'mct_vagent.ini';
VPLAYERS_CONFIG_FILE = 'mct_vplayers.ini';
LOG_NAME             = 'MCT_VDriver';
LOG_FORMAT           = '%(asctime)s %(name)-12s %(levelname)-8s %(message)s';
LOG_FILENAME         = '/var/log/mct/mct_vdriver.log';
...
class MCT_Action(object):
    ...
    ** reset_instance    ==
    ...
    def __init__(self, config):
        ...
        ## CONFIG_FILE path.
        self.__cfgAgent  = get_configs(VAGENT_CONFIG_FILE);
        ...
        self.__publish = RabbitMQ_Publish(amqpConfig);
