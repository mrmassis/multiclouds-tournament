...
echo "PLAYERS REQUESTS FAIRNESS"        > ${STATUS_FILE}
...
echo "NAME SCORE HISTORY FAIRNESS" > ${DIVISION1_FILE}
echo "NAME SCORE HISTORY FAIRNESS" > ${DIVISION2_FILE}
echo "NAME SCORE HISTORY FAIRNESS" > ${DIVISION3_FILE}
echo "NAME SCORE HISTORY FAIRNESS" > ${ELIMINATD_FILE}
